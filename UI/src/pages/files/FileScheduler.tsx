...
import { useGetFileGroupsQuery, useCreateFileScheduleMutation } from '../../api/fileApi';
import ErrorAlert from '../../components/ErrorAlert';
import LoadingSpinner from '../../components/LoadingSpinner';

const FileScheduler: React.FC = () => {
  ...
  const [createSchedule, { isLoading: isCreatingSchedule }] = useCreateFileScheduleMutation();
  ...
  return (
    <div className="bg-white shadow rounded-lg p-6">
      <h2 className="text-lg font-medium text-gray-900 mb-4">Schedule File Publication</h2>
