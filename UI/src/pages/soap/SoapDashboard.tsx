    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-800">SOAP API Management</h1>
        </div>
        <p className="text-gray-600 mb-6">Configure and manage SOAP web service virtual endpoints</p>
      </div>
