...
/**
 * Component for publishing messages on-demand to Tibco EMS queues and topics
 */
const TibcoOnDemandPublish: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="bg-white shadow rounded-lg p-6">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Publish Message to Tibco EMS Queue or Topic</h2>
...
export default TibcoOnDemandPublish; 