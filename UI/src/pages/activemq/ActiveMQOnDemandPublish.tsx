...
/**
 * Component for publishing messages on-demand to ActiveMQ queues and topics
 */
const ActiveMQOnDemandPublish: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="bg-white shadow rounded-lg p-6">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Publish Message to ActiveMQ Queue or Topic</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <select
                ...
                onChange={(e) => handleInputChange({ target: { name: 'destinationType', value: e.target.value } } as any)}
...
export default ActiveMQOnDemandPublish; 