...
public class IBMMQStubInitializer {
    ...
    @Autowired
    public IBMMQStubInitializer(IBMMQStubService ibmMQStubService) {
    ...
    public void initializeActiveStubs() {
        ...
        try {
            ...
            List<IBMMQStub> activeStubs = ibmMQStubService.findByStatus(StubStatus.ACTIVE);
     ...
     */
    private CompletableFuture<Void> initializeStub(IBMMQStub stub) {
