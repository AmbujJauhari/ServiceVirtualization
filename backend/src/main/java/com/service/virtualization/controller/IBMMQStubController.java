...
import com.service.virtualization.dto.IBMMQStubDTO;
...
public class IBMMQStubController {
    ...
    public ResponseEntity<IBMMQStubDTO> updateStubStatus(@PathVariable String id, @RequestBody Map<String, Boolean> statusUpdate) {
