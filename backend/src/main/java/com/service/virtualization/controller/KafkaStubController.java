...
import com.service.virtualization.mapper.KafkaStubMapper;
...
public class KafkaStubController {
    ...
    public ResponseEntity<KafkaStubDTO> getKafkaStubById(@PathVariable String id) {
        ...
        KafkaStub kafkaStub = kafkaStubService.getStubById(id);
        if (kafkaStub == null) {
            return ResponseEntity.notFound().build();
        }
        
        return ResponseEntity.ok(kafkaStubMapper.toDTO(kafkaStub));
    }
    ...
    public ResponseEntity<KafkaStubDTO> updateKafkaStub(@PathVariable String id, 
        ...
        KafkaStub kafkaStub = kafkaStubMapper.toModel(kafkaStubDTO);
        KafkaStub updatedStub = kafkaStubService.updateStub(kafkaStub);
